...
public class MoltronMechEntity extends Monster {
	public MoltronMechEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MurrayModEntities.MOLTRON_MECH.get(), world);
	}

	public MoltronMechEntity(EntityType<MoltronMechEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(MurrayModItems.MECH_STRIKE.get()));
	}
