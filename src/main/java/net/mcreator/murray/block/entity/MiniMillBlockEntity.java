...
public class MiniMillBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public MiniMillBlockEntity(BlockPos position, BlockState state) {
		super(MurrayModBlockEntities.MINI_MILL.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("mini_mill");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Mini Mill");
	}
