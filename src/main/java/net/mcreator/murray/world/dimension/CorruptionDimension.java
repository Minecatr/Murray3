...
public class CorruptionDimension {
	...
	public static class Fixers {
		...
		public static void registerFillerBlocks(FMLCommonSetupEvent event) {
			...
			replaceableBlocks.add(MurrayModBlocks.CORRUPTION_GRASS.get());
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("murray:corruption"), customEffect));
		}
	}
}
