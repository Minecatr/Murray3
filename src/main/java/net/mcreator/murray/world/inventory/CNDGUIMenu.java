...
public class CNDGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CNDGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MurrayModMenus.CNDGUI.get(), id);
