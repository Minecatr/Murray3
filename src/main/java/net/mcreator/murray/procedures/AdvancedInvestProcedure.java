...
public class AdvancedInvestProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
		...
		}.getItemStack(world, new BlockPos(x, y, z), 0)).getItem() == Items.DIAMOND && !(new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _slotid = 1;
					final ItemStack _setstack = new ItemStack(MurrayModItems.MINECOIN.get());
		...
		}.getItemStack(world, new BlockPos(x, y, z), 0)).getItem() == MurrayModItems.MINECOIN.get() && !(new Object() {
			public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
				AtomicInteger _retval = new AtomicInteger(0);
				BlockEntity _ent = world.getBlockEntity(pos);
				if (_ent != null)
		...
		}.getAmount(world, new BlockPos(x, y, z), 1) >= 63)) {
