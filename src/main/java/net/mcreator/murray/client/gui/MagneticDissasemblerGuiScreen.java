...
public class MagneticDissasemblerGuiScreen extends AbstractContainerScreen<MagneticDissasemblerGuiMenu> {
	private final static HashMap<String, Object> guistate = MagneticDissasemblerGuiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MagneticDissasemblerGuiScreen(MagneticDissasemblerGuiMenu container, Inventory inventory, Component text) {
