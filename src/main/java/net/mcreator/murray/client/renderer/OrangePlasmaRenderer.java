...
public class OrangePlasmaRenderer extends EntityRenderer<OrangePlasmaEntity> {
	...
	@Override
	public void render(OrangePlasmaEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(OrangePlasmaEntity entity) {
		return texture;
	}
}
