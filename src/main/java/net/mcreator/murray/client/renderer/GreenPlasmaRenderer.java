...
public class GreenPlasmaRenderer extends EntityRenderer<GreenPlasmaEntity> {
	...
	@Override
	public void render(GreenPlasmaEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(GreenPlasmaEntity entity) {
		return texture;
	}
}
