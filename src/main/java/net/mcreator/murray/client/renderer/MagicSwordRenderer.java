...
public class MagicSwordRenderer extends EntityRenderer<MagicSwordEntity> {
	...
	public MagicSwordRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelMagicSword(context.bakeLayer(ModelMagicSword.LAYER_LOCATION));
	}

	@Override
	public void render(MagicSwordEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(MagicSwordEntity entity) {
		return texture;
	}
}
