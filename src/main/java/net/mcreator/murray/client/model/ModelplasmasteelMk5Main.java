...
public class ModelplasmasteelMk5Main<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("murray", "modelplasmasteel_mk_5_main"),
			"main");
	...
	public ModelplasmasteelMk5Main(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Chest_r1 = Body.addOrReplaceChild("Chest_r1",
				CubeListBuilder.create().texOffs(19, 20).addBox(-4.0F, -21.0F, -7.0F, 8.0F, 3.0F, 1.0F, new CubeDeformation(1.01F)),
