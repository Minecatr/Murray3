...
public class Modelirongolem_V2<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("murray", "modelirongolem_v_2"), "main");
	...
	public Modelirongolem_V2(ModelPart root) {
