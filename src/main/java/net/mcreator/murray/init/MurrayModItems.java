...
public class MurrayModItems {
	...
	public static final RegistryObject<Item> TRAIL_ICE = block(MurrayModBlocks.TRAIL_ICE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Item> MOLTRON_MECH = REGISTRY.register("moltron_mech_spawn_egg",
			() -> new ForgeSpawnEggItem(MurrayModEntities.MOLTRON_MECH, -65536, -16777216, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	...
	public static final RegistryObject<Item> CORRUPTION_GRASS = block(MurrayModBlocks.CORRUPTION_GRASS, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> ACTIVE_CORRUPTION_GRASS = block(MurrayModBlocks.ACTIVE_CORRUPTION_GRASS,
			CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> SILICA = block(MurrayModBlocks.SILICA, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> PARTICLE = block(MurrayModBlocks.PARTICLE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> KING = block(MurrayModBlocks.KING, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> CORRUPT_PARTICLE = block(MurrayModBlocks.CORRUPT_PARTICLE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> RIFT = block(MurrayModBlocks.RIFT, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> DRILL = block(MurrayModBlocks.DRILL, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> DEPOSIT = block(MurrayModBlocks.DEPOSIT, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> CORRUPTED_CRATE = block(MurrayModBlocks.CORRUPTED_CRATE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> BRUTE_CRATE = block(MurrayModBlocks.BRUTE_CRATE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> ORNATE_CRATE = block(MurrayModBlocks.ORNATE_CRATE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> VEX_CRATE = block(MurrayModBlocks.VEX_CRATE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> PURPLE_SOLDIER = REGISTRY.register("purple_soldier_spawn_egg",
			() -> new ForgeSpawnEggItem(MurrayModEntities.PURPLE_SOLDIER, -3407617, -16777216, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> VEXX = REGISTRY.register("vexx_spawn_egg",
			() -> new ForgeSpawnEggItem(MurrayModEntities.VEXX, -16777216, -3407617, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> BRUTE = REGISTRY.register("brute_spawn_egg",
			() -> new ForgeSpawnEggItem(MurrayModEntities.BRUTE, -3407617, -6750004, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	...
	public static final RegistryObject<Item> MOLTRON_ROCKET = REGISTRY.register("moltron_rocket_spawn_egg",
			() -> new ForgeSpawnEggItem(MurrayModEntities.MOLTRON_ROCKET, -65536, -1, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> COMPUTER = block(MurrayModBlocks.COMPUTER, CreativeModeTab.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Item> MAGNETITE_ORE = block(MurrayModBlocks.MAGNETITE_ORE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> MAGNETITE_BLOCK = block(MurrayModBlocks.MAGNETITE_BLOCK, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> MAGNET_A = block(MurrayModBlocks.MAGNET_A, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> MAGNET_B = block(MurrayModBlocks.MAGNET_B, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> VENUS_STONE = block(MurrayModBlocks.VENUS_STONE, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> ADVANCED_COMPUTER = block(MurrayModBlocks.ADVANCED_COMPUTER, CreativeModeTab.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Item> MAGNETIC_DISASSEMBLER = block(MurrayModBlocks.MAGNETIC_DISASSEMBLER,
			CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> WOODEN_SOLAR_PANEL = block(MurrayModBlocks.WOODEN_SOLAR_PANEL, CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Item> MINI_MILL = block(MurrayModBlocks.MINI_MILL, CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Item> MINI_MILL_2 = block(MurrayModBlocks.MINI_MILL_2, CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Item> THE_SUN_IN_A_BOX = block(MurrayModBlocks.THE_SUN_IN_A_BOX, CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Item> HOT_MATTER = REGISTRY.register("hot_matter", () -> new HotMatterItem());
	public static final RegistryObject<Item> TREE_IN_A_BOX = block(MurrayModBlocks.TREE_IN_A_BOX, CreativeModeTab.TAB_DECORATIONS);
	...
	public static final RegistryObject<Item> FORCEFIELD_BLOCK = block(MurrayModBlocks.FORCEFIELD_BLOCK, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> X_ZSWAP = REGISTRY.register("x_zswap", () -> new XZswapItem());
	public static final RegistryObject<Item> CND = block(MurrayModBlocks.CND, CreativeModeTab.TAB_BUILDING_BLOCKS);
