...
public abstract class MagnetiteArmorItem extends ArmorItem {
	...
	public static class Helmet extends MagnetiteArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "murray:textures/models/armor/magnetite__layer_1.png";
		}
	...
	public static class Chestplate extends MagnetiteArmorItem {
		...
		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			MagnetiteChestplateEventProcedure.execute(world, entity);
		}
	}
	...
	public static class Leggings extends MagnetiteArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "murray:textures/models/armor/magnetite__layer_2.png";
		}

		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			MagnetiteLeggingsEventProcedure.execute(entity);
		}
	}
	...
	public static class Boots extends MagnetiteArmorItem {
		...
		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			MagnetiteBootsEventProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		}
	}
}
