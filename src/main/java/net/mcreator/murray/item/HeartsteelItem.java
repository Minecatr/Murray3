...
import net.mcreator.murray.procedures.HeartsteelBodyTickEventProcedure;
import net.mcreator.murray.init.MurrayModTabs;

public abstract class HeartsteelItem extends ArmorItem {
	public HeartsteelItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends HeartsteelItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "murray:textures/models/armor/heartsteel__layer_1.png";
		}
	...
	public static class Chestplate extends HeartsteelItem {
		public Chestplate() {
		...
		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			HeartsteelBodyTickEventProcedure.execute(entity);
		}
	}

	public static class Leggings extends HeartsteelItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "murray:textures/models/armor/heartsteel__layer_2.png";
		}
	}

	public static class Boots extends HeartsteelItem {
		public Boots() {
