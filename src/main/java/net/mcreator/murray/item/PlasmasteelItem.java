...
public abstract class PlasmasteelItem extends ArmorItem {
	public PlasmasteelItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends PlasmasteelItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "murray:textures/models/armor/plasmasteel__layer_1.png";
		}
	...
	public static class Chestplate extends PlasmasteelItem {
		public Chestplate() {
	...
	public static class Leggings extends PlasmasteelItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "murray:textures/models/armor/plasmasteel__layer_2.png";
		}
	}

	public static class Boots extends PlasmasteelItem {
		public Boots() {
