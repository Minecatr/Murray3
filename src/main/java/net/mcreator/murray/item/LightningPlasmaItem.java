...
import net.mcreator.murray.procedures.CooldownFastProcedure;
import net.mcreator.murray.init.MurrayModTabs;
import net.mcreator.murray.entity.LightningPlasmaEntity;

public class LightningPlasmaItem extends Item {
	public LightningPlasmaItem() {
	...
	public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				LightningPlasmaEntity entityarrow = LightningPlasmaEntity.shoot(world, entity, world.getRandom(), 2f, 0, 0);
