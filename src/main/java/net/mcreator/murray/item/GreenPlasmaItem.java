...
import net.mcreator.murray.procedures.CooldownProcedure;
import net.mcreator.murray.init.MurrayModTabs;
import net.mcreator.murray.entity.GreenPlasmaEntity;

public class GreenPlasmaItem extends Item {
	public GreenPlasmaItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				GreenPlasmaEntity entityarrow = GreenPlasmaEntity.shoot(world, entity, world.getRandom(), 2f, 2, 2);
